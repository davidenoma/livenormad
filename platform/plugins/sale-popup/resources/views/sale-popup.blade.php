        ...
        <div class="sale-popup-container">
            ...
            <div class="sale-popup-info">
                ...
                <div class="sale-popup-ago">
                    ...
                    @if ($salePopupHelper->getSetting('show_verified', 1))
                        <span class="sale-popup-verify"><i
                                class="las la-check-circle"></i>{{ $salePopupHelper->getSetting('verified_text', 'Verified') }}</span>
                    @endif
                </div>
            </div>
            ...
            @if ($salePopupHelper->getSetting('show_quick_view_button', 1))
                <a
                    ...
                    rel="nofollow"
                >
                    <span title="{{ $salePopupHelper->getSetting('quick_view_text', 'Quick view') }}"><i
                            class="fal fa-eye"
                        ></i></span>
                </a>
            @endif
