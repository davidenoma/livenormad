<div class="navigation-bar">
    <ul class="navigation-bar__list">
        <li>
            <a href="{{ route('public.index') }}" class="text-truncate" title="{{ __('Home') }}">
            ...
            <li>
                <a href="{{ route('public.wishlist') }}" class="text-truncate" title="{{ __('Wishlist') }}">
                    <div class="header-cart p-relative">
                        ...
                        <span class="tp-product-count text-white" style="inset-inline-end: 2px">{{ Cart::instance('wishlist')->count() }}</span>
                    </div>
                    @if($showMenuLabel)
